...
GameText* loadPrompts(sf::Text tempText, vector <vector <string>> ignorePrompt, GameText* ignorePromptTextPtr, sf::RenderWindow& window, const std::optional<std::string>& randomInt_String = std::nullopt) {
